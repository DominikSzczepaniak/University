...
if __name__ == "__main__":
    ...
    list_book_api.add_argument('--book_id', required=True, help='ID of the book')

    delete_book_api = subparsers.add_parser('delete_book', help='Delete a book')
    delete_book_api.add_argument('--book_id', required=True, help='ID of the book')
