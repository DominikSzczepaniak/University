...
namespace POOLista7
{
    ...
    public class listaBA
    {
        ...
        public listaBA(listaBB b)
        {
            this.b = b;
        }

        [DependencyProperty]
        public listaBC TheC { get; set; }

        [DependencyMethod]
        public void SetD(listaBD d)
        {
            this.d = d;
        }
    ...
    public class listaBB { }
    public class listaBC { }
    public class listaBD { }

    public class AZadanie2
    {
        public BZadanie2 b;
        private DZadanie2 d;

        public AZadanie2(BZadanie2 b)
        {
            this.b = b;
        }

        [DependencyProperty]
        public CZadanie2 TheC { get; set; }

        [DependencyMethod]
        public void SetD(DZadanie2 d)
        {
            this.d = d;
        }

        public DZadanie2 GetD()
        {
            return d;
        }
    }
    public class BZadanie2 { }
    public class CZadanie2 { }
    public class DZadanie2 { }

    [TestFixture]
    public class SimpleContainerTests
    {
        [Test]
        public void BuildUp_ShouldInjectPropertyAndMethodDependencies()
        {
            SimpleContainer container = new SimpleContainer();
            container.RegisterType<CZadanie2>(false);
            container.RegisterType<DZadanie2>(false);

            BZadanie2 b = new BZadanie2();
            AZadanie2 a = new AZadanie2(b);

            ClassicAssert.IsNotNull(a);
            ClassicAssert.IsNotNull(a.b);
            ClassicAssert.IsNull(a.TheC);
            ClassicAssert.IsNull(a.GetD());

            container.BuildUp(a);

            ClassicAssert.IsNotNull(a.TheC);
            ClassicAssert.IsNotNull(a.GetD());
        }

        [Test]
        public void Resolve_ShouldInjectConstructorPropertyAndMethodDependencies()
        {
            SimpleContainer container = new SimpleContainer();
            container.RegisterType<listaBB>(false);
            container.RegisterType<listaBC>(false);
            container.RegisterType<listaBD>(false);

            listaBA a = container.Resolve<listaBA>();
