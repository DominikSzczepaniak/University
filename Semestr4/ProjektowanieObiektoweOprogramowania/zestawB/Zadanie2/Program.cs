...
namespace POOLista7
{
    ...
    public class SimpleContainer
    {
        ...
        private object CreateInstance(Type type)
        {
            ...
            var instance = selectedConstructor.Invoke(parameterInstances);
            InjectProperties(instance);
            InjectMethods(instance);
        ...
        private void InjectProperties(object instance)
        {
            var properties = instance.GetType().GetProperties()
                .Where(p => p.GetCustomAttribute<DependencyPropertyAttribute>() != null && p.CanWrite);
        ...
        private void InjectMethods(object instance)
        {
            var methods = instance.GetType().GetMethods()
                .Where(m => m.GetCustomAttribute<DependencyMethodAttribute>() != null &&
            ...
            foreach (var method in methods)
            {
                ...
                method.Invoke(instance, parameterInstances);
            }
        }
    }
}
