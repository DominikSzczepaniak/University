...
class Jungle:
    ...
    def calculate_distance(self, pieces, player):
    ...
    def evaluate(self, player):
        ...
        player_score -= self.calculate_distance(self.pieces[player], player) + self.calculate_distance(
            self.pieces[1 - player], 1 - player)
    ...
    def choose_move_simulation(self, moves, player, N=20000): #losowy agent
        pieces_copy = copy.deepcopy(self.pieces)
        board_copy = copy.deepcopy(self.board)
        curr_player_copy = self.curplayer
        peace_counter_copy = self.peace_counter
...
for i in range(10):
    ...
    if won == 1:
        ...
        print("draw")
        draw_cnt += 1
print("ALPHABETA: " + str(won_0) + ", RANDOM: " + str(won_1) + ", draw: " + str(draw_cnt))