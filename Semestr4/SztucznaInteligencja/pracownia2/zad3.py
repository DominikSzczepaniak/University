...
class Commando:
    ...
    def heuristic(self, positions, path_lenght):
        return path_lenght + max([self.minDistance[pos[0]][pos[1]] for pos in positions])
    ...
    def AStar(self, positions, moves):
        Q = []
        heapq.heappush(Q, (self.heuristic(positions, 0), (positions, moves)))
        self.visited = set()
