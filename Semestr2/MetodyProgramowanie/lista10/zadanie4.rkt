...
(define (elimination-cond [e : Exp]) : Exp
  (type-case Exp e
    [(numE n) (numE n)]
    [(opE o l r) (opE o (elimination-cond l) (elimination-cond r))]
    [(ifE b l r) (ifE (elimination-cond b) (elimination-cond l) (elimination-cond r))]
    [(condE cs)
     (cond->if cs)]))

(define (run [e : S-Exp]) : Value
  (eval (elimination-cond (parse e))))
